...
module.exports.handleEvent = async ({ api, event, Threads }) => {
  ...
  if (event.body.startsWith("🥰")) {
    ...
    var rahad = [
      "_জীবনে খুব সাধারণ একটা  মা'নুষ আসুক-:))💜🍂\n\n     _যে আমায় ছাড়া কিছু না বুঝুক-!🖤🥺<⎯͢⎯⃝༉༎𝐌𝐨𝐡𝐚𝐦𝐦𝐚𝐝_𝐊𝐚𝐛𝐢𝐫<😻😽>⎯͢༉☺️>",
      "____𝘀𝗼𝗺𝗲𝗼𝗻𝗲 𝗶𝘀 𝗯𝘂𝘀𝘆 𝗳𝗶𝗻𝗱𝗶𝗻𝗴 𝗻𝗲𝘄 𝗔𝗻𝗱 𝘀𝗼𝗺𝗲𝗼𝗻𝗲 𝗶𝘀 𝘂𝗲𝘀𝗱 𝘁𝗼 𝘁𝗵𝗲 𝗼𝗹𝗱-!!💚🌼🍒\n\n___কেউ নতুন খুঁজতে ব্যাস্ত আর কেউ পুরোনো তেই অভ্যস্ত-!!💚🌼🍒<⎯͢⎯⃝༉༎𝐌𝐨𝐡𝐚𝐦𝐦𝐚𝐝_𝐊𝐚𝐛𝐢𝐫<😻😽>⎯͢༉☺️>",
"𝗜 𝗪𝗮𝗻𝘁 𝗬𝗼𝘂 𝗧𝗼 𝗕𝗲 𝗠𝘆 𝗙𝗲𝗲𝗹𝗶𝗻𝗴𝘀❀🩷💌✨



•─ “আমি চাই না তুমি আমার অভ্যাস হয়ে যাও” ❤️‍🩹😇...<⎯͢⎯⃝༉༎𝐌𝐨𝐡𝐚𝐦𝐦𝐚𝐝_𝐊𝐚𝐛𝐢𝐫<😻😽>⎯͢༉☺️>",
    ];
